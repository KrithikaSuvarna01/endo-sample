...
to your account" image="/login-page-image-1.svg" subtitle="Please sign in to your account" children={<LoginForm />} />} />
        ...
        <Route path="/forgot-password" element={<LoginPage title="Reset Password 🔒" text1="Enter your new password" text2="for account access." image='/reset-password-img.svg' subtitle="Please enter your email address" children={<ForgotPasswordForm />} />} />
      </Routes>
    </BrowserRouter>
  )
}
