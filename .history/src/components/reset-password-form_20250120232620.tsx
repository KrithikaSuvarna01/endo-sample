...
export const ResetPasswordForm = () => { 
 ...
 async function handlePasswordReset(event: React.FormEvent<HTMLFormElement>) {
  ...
  try {
    // Filter out non-mutable attributes (e.g., email_verified)
    const mutableAttributes = { ...userAttributes };
    delete mutableAttributes.email_verified; // Remove email_verified
    delete mutableAttributes.sub; // Remove sub if present
