  ...
  return (
    <div className="bg-custom-gradient w-full h-full relative">
      ...
      >
        ...
        <div className=" bg-login-bg border-2 border-red-500  absolute w-[56.72vw] right-[1.62%] top-[3.21%] bottom-[3.21%]  rounded-[24px] flex justify-center items-center ">
          <div className="w-[68.47%] h-[64.58%]  flex justify-center items-center relative">

   <div className="  shadow-login bg-login-bg !z-50 bg-login py-[52px] px-[32px] rounded-[58px] border-[2px] border-yellow-800 "></div>
