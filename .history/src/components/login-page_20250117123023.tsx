...
<div className=" shadow-login bg-login-bg !z-50  w-[87.20%] h-[70.65%]  rounded-[58px] border-[2px] border-red-900 ">
    ...
    <img src="/bottom-shape-login.svg"  className=" w-[32.08%] h-[29.03%] bg-cover absolute border-2 border-red-800 right-0 bottom-0 z-0">
          ...
          <div className="  border-2 border-red-900 flex align-baseline gap-[0.61%] absolute top-[6.25%] left-[4.44%]">
            <img src="/tooth.svg" className="h-[96.77%] w-[19.10%]" />
            <div className=" flex flex-col gap-[5.88%] justify-end max-w-[20vw]  items-center">
            <h1 className=" text-[2rem] leading-[35.2px] font-semibold">ENDO<span className="text-main-text">DONTIST</span></h1>
            <h3 className=" inline-block w-full font-thin text-[0.75rem] leading-[13.2px] tracking-[0.3em] text-something">YOUR SMILE, OUR EXPERTISE</h3>
          </div>
          </div>
        </div>
