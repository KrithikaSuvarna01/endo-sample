...
<div className=" shadow-login bg-login-bg z-999  w-[45.94%] h-[42.77%]  rounded-[58px] border-[2px] border-red-900 relative">
    <div style={{ backgroundImage: `url('/top-shape-login.svg')` }} className=" w-[52.76%] border-[2px] border-red-900 h-[53.32%] bg-cover absolute left-[-12.22%] top-[-12.78%] z-0">

    </div>
    <div style={{ backgroundImage: `url('/bottom-shape-login.svg')` }}  className=" w-[40%] h-[41.1%] bg-cover absolute border-[2px] border-red-900 right-[-12.22%] bottom-[-12.7%] z-0">
