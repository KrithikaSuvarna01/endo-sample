            ...
            <div className="  shadow-login  bg-login-bg !z-50 bg-login py-[52px] px-[32px] rounded-[58px] border-[2px] border-green-800 ">
              ...
              <form className=" flex flex-col gap-5"> 
                <fieldset className=" flex flex-col gap-[16px]">
                  ...
                  <input id="email"  className=" py-[7px] px-[14px] w-full max-h-[38px] rounded-[10px] border-[1px] border-[#B8A0FF] placeholder:text[15px] placeholder:font:normal placeholder:leading-4  " placeholder="john.doe@gmail.com" />
                </fieldset>
                <fieldset className=" flex flex-col gap-[16px]">
                  ...
                  <input id="email"  type="password" className=" py-[7px] px-[14px] w-full max-h-[38px] rounded-[10px] border-[1px] border-[#B8A0FF]  focus:border-[2px] focus:border-[#9270f9]"  />
                </fieldset>
