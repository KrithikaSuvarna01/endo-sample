 ...
 if (result.status === "success") {
    ...
    return (
      <form className=" flex flex-col gap-5" onSubmit={handleLogin} > 
          ...
          <input id="password" name="password" type="password" className="  py-[0.4375rem] px-[0.875rem] w-full max-h-[8.68%] rounded-[0.625rem] border-[0.0625rem] border-[#B8A0FF]  outline-none relative" />
          <button
                  type="button"
                  onClick={() => {
