...
import { newPasswordReset } from "../services/authentication";
...
const { userAttributes,email,isFirstLogin } = location.state || {};
  ...
  const newPassword = formData.get("new-password") as string;
    ...
    nonMutableAttributes.forEach((attr) => delete mutableAttributes[attr]);
      ...
      cognitoUser?.completeNewPasswordChallenge(newPassword, mutableAttributes, {
        ...
        const result = await newPasswordReset(email, newPassword);
        console.log(result);
    }
