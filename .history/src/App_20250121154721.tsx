...
to your account" image="/login-page-image-1.svg" subtitle="Please sign in to your account" children={<LoginForm />} />} />
        ...
        <Route path="/login-success" element={<LoginPage title="Your password has been changed successfully" text1="Enter your new password" text2="for account access." image='/login-successful-img.svg' subtitle="Enter your email ID or mobile number to reset your password" children={<NumberVerificationForm />} />} />
      </Routes>
    </BrowserRouter>
  )
}
