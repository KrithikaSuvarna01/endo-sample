...
import { LoginSuccessful } from "./components/login-successful";
...
to your account" image="/login-page-image-1.svg" subtitle="Please sign in to your account" children={<LoginForm />} />} />
        ...
        <Route path="/otp-verification" element={<LoginPage title="Verify your Number 💬" text1="Enter 6 digit security code" text2="for two-step verification" image='/verify-number-img.svg' subtitle="Enter your email ID or mobile number to reset your password" children={<NumberVerificationForm />} />} />
        <Route path="/login-success" element={<LoginPage title="Your password has been changed successfully" text1="Enter your new password" text2="for account access." image='/login-successful-img.svg' subtitle="Enter your email ID or mobile number to reset your password" children={<LoginSuccessful />} />} />
      </Routes>
    </BrowserRouter>
  )
}
