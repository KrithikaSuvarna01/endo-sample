...
export const initiateForgotPassword = async(email: string) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    const userData = { Username: "+918075805519", Pool: userPool };
...
export const confirmForgotPassword = (email: string, otp: string,newPassword: string) => {
  const userPool = getUserPool(import.meta.env.VITE_USER_POOL_ID, import.meta.env.VITE_CLIENT_ID);
...
//       cognitoUser.confirmForgotPassword(newPassword, {}, {
//         onSuccess: (data) => {
