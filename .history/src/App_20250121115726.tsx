...
to your account" image="/login-page-image-1.svg" subtitle="Please sign in to your account" children={<LoginForm />} />} />
        ...
        <Route path="/forgot-password" element={<LoginPage title="Forgot Password? 🔒" text1="Enter your new password" text2="for account access." image='/forgot-password-img.svg' subtitle="Enter your email ID or mobile number to reset your password" children={<ForgotPasswordForm />} />} />
      </Routes>
    </BrowserRouter>
  )
}
